        ...
        <div className={cx('cform-box reveal rd1')}>
          ...
          <form onSubmit={submitContact}>
            <div className={cx('cf-row')}>
              <div className={cx('cfg')}><label className={cx('cf-label')}>First Name *</label><input className={cx('cf-inp')} type="text" placeholder="John" required /></div>
              <div className={cx('cfg')}><label className={cx('cf-label')}>Last Name</label><input className={cx('cf-inp')} type="text" placeholder="Smith" /></div>
            </div>
            <div className={cx('cfg')}><label className={cx('cf-label')}>Phone *</label><input className={cx('cf-inp')} type="tel" placeholder="04XX XXX XXX" required /></div>
            <div className={cx('cfg')}><label className={cx('cf-label')}>Email</label><input className={cx('cf-inp')} type="email" placeholder="you@email.com" /></div>
            <div className={cx('cfg')}><label className={cx('cf-label')}>Service Required</label><select className={cx('cf-sel')} defaultValue=""><option value="">Select a service…</option><option>Exterior Painting</option><option>Interior Painting</option><option>Weatherboard Restoration</option><option>Doors & Trim</option><option>New Construction</option><option>Porch / Deck</option><option>Other</option></select></div>
            <div className={cx('cfg')}><label className={cx('cf-label')}>Project Details</label><textarea className={cx('cf-ta')} placeholder="Describe your property and the work needed…" rows={4}></textarea></div>
